...
class UserPeminjamModel extends Model
{
    ...
    protected $allowedFields = ['id_barang', 'total_dipinjam', 'nama_lengkap', 'slug', 'pekerjaan', 'email', 'no_telepon', 'alamat', 'kepentingan', 'kode_peminjaman', 'status', 'keterangan', 'tanggal_pengajuan', 'tanggal_dipinjamkan', 'tanggal_perkiraan_dikembalikan', 'tanggal_dikembalikan', 'catatan_peminjaman'];
    ...
    public function getNamaLengkapBySlug($slug)
    {
        $builder = $this->db->table('tb_user_peminjam');
        $builder->select('
        tb_user_peminjam.*, 
    ...
    ');
        ...
        // Menambahkan kondisi untuk mencari berdasarkan slug
        $builder->where('tb_user_peminjam.slug', $slug);
