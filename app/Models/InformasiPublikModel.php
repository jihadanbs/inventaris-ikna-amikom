...
{
    protected $table = 'tb_informasi_publik';
    protected $primaryKey = 'id_informasi_publik';
    protected $retunType = 'object';
    protected $allowedFields = ['id_lembaga', 'id_jenis', 'id_pengunjung', 'id_kategori_informasi_publik', 'tanggal_file', 'judul', 'slug', 'deskripsi', 'file_informasi_publik', 'link_informasi_publik', 'email_pengunjung'];
    ...
    {
        $builder = $this->db->table('tb_informasi_publik');
        $builder->select('tb_informasi_publik.*, tb_lembaga.nama_dinas, tb_kategori_informasi_publik.nama_kategori, tb_jenis.nama_jenis');
        $builder->join('tb_lembaga', 'tb_lembaga.id_lembaga = tb_informasi_publik.id_lembaga');
        ...
        $builder->orderBy('tb_informasi_publik.id_informasi_publik', 'DESC');
        $query = $builder->get();
        ...
        foreach ($results as $result) {
            $id_informasi_publik = $result->id_informasi_publik;
            $additional_data = $this->getDokumenById($id_informasi_publik);
