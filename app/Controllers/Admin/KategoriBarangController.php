    ...
    public function save()
    {
        ...
        if ($this->request->isAJAX()) {
            ...
            if ($existing_data) {
                ...
                return $this->response->setStatusCode(400)->setJSON(['error' => 'Nama Kategori Barang sudah ada dalam database !']);
            }
    ...
    public function simpan_perubahan()
    {
        ...
        foreach ($dataToSave as $data) {
            ...
            if ($existingData) {
                ...
                return $this->response->setJSON(['success' => false, 'message' => 'Nama kategori Barang sudah ada dalam database !']);
            }
        }
