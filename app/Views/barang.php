...
<body class="sub_page">
    ...
    <div class="d-flex justify-content-between align-items-center w-100">
        ...
        <li class="nav-item" id="kategori4">
            <a class="nav-link" data-toggle="tab" href="#kategoritab4">kategori 4</a>
        </li>
        ...
        <li class="nav-item" id="kategori6">
            <a class="nav-link" data-toggle="tab" href="#kategoritab6">Kategori 7</a>
        </li>
        <li class="nav-item" id="kategori6">
            <a class="nav-link" data-toggle="tab" href="#kategoritab6">Kategori 8</a>
        </li>
        </ul>
        <button class="btn btn-secondary" id="scrollRightBtn">&gt;</button>
            ...
            <div class="tab-pane fade" id="kategoritab5">
            <div class="tab-pane fade show active" id="kategoritab1">
