                            ...
                            <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                              ...
                              <tr>
                                <td align="center" class="es-m-txt-c es-text-2968" style="padding:0;Margin:0;padding-bottom:10px">
                                  <h1 style="Margin:0;font-family:arial, 'helvetica neue', helvetica, sans-serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:36px;font-style:normal;font-weight:bold;line-height:54px;color:#333333" align="center">Anda Berhasil Melakukan Pengajuan Keberatan Informasi Publik</h1>
                                </td>
                              </tr>
                              <tr>
                                <td align="center" class="es-m-p0r es-m-p0l es-text-9928" style="Margin:0;padding-top:5px;padding-right:40px;padding-bottom:5px;padding-left:40px">
                                  <p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">Untuk tahapan penggunaan selanjutnya terdapat kode keberatan yang bisa anda digunakan untuk mengecek <strong>STATUS</strong> dari keberatan anda.</p>
                                </td>
                              </tr>
                              <tr>
                              ...
                              <tr>
                                <td align="left" class="es-text-5833" style="padding:0;Margin:0">
                                  ...
                                  <h3 style="Margin:0;font-family:arial, 'helvetica neue', helvetica, sans-serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:20px;font-style:normal;font-weight:bold;line-height:30px !important;color:#333333;margin-left:40px" class="es-text-mobile-size-14">NAMA : <?= $nama ?></h3>
                                  <h3 style="Margin:0;font-family:arial, 'helvetica neue', helvetica, sans-serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:20px;font-style:normal;font-weight:bold;line-height:30px !important;color:#333333;margin-left:40px" align="justify" class="es-text-mobile-size-14">EMAIL : <?= $email ?></h3>
                                  <h3 style="Margin:0;font-family:arial, 'helvetica neue', helvetica, sans-serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:20px;font-style:normal;font-weight:bold;line-height:30px !important;color:#333333;margin-left:40px" align="justify" class="es-text-mobile-size-14">NO TELEPON : <?= $no_telepon ?></h3>
                                  <h3 style="Margin:0;font-family:arial, 'helvetica neue', helvetica, sans-serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:20px;font-style:normal;font-weight:bold;line-height:30px !important;color:#333333;margin-left:40px" class="es-text-mobile-size-14">RINGKASAN KASUS : <?= $ringkasan_kasus ?></h3>
                                </td>
                              </tr>
                              <tr>
                                <td align="center" style="padding:20px;Margin:0;font-size:0">
                            ...
                            <table cellpadding="0" cellspacing="0" width="100%" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:separate;border-spacing:0px;border-left:2px dashed #cccccc;border-right:2px dashed #cccccc;border-top:2px dashed #cccccc;border-bottom:2px dashed #cccccc;border-radius:5px" role="presentation">
                              <tr>
                                <td align="center" class="es-m-txt-c es-text-4060" style="padding:0;Margin:0;padding-right:20px;padding-left:20px;padding-top:20px">
                                  <h2 style="Margin:0;font-family:arial, 'helvetica neue', helvetica, sans-serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:26px;font-style:normal;font-weight:bold;line-height:31px;color:#333333">KODE KEBERATAN</h2>
                                </td>
                              </tr>
                              <tr>
                                <td align="center" class="es-m-txt-c es-text-4952" style="Margin:0;padding-top:10px;padding-right:20px;padding-left:20px;padding-bottom:20px">
                                  <h1 style="Margin:0;font-family:arial, 'helvetica neue', helvetica, sans-serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:46px;font-style:normal;font-weight:bold;line-height:55px;color:#5c68e2"><strong><?= $kode_keberatan ?></strong></h1>
                                </td>
                              </tr>
                              <tr>
