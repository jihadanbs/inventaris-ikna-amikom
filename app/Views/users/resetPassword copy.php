                ...
                <form action="" method="POST" class="sign-in-form">
                    ...
                    <div class="custom-form-group">
                        ...
                        <div class="custom-input-field">
                            ...
                            <input type="password" id="pw" name="password" placeholder="Masukkan kata sandi" value="<?= isset($old_input['password']) ? $old_input['password'] : '' ?>">
                        </div>
                    ...
                    <div class="custom-form-group">
                        <label for="konfirmasi_pw" class="custom-form-label">Konfirmasi Kata Sandi</label>
                        <div class="custom-input-field">
                            <i class="fas fa-lock password-toggle" onclick="togglePasswordVisibility('konfirmasi_pw', this)"></i>
                            <input type="password" id="konfirmasi_pw" name="konfirmasi_password" placeholder="Konfirmasi kata sandi" value="<?= isset($old_input['konfirmasi_password']) ? $old_input['konfirmasi_password'] : '' ?>">
                        </div>
                        ...
                        <?php endif; ?>
                        <a href="<?= site_url("authentication/lupaPassword"); ?>" style="color: black; text-align:right; display: block;">Lupa kata sandi?</a>
                    </div>


                    <input type="submit" value="Reset Password" class="custom-btn solid" />
                </form>
            </div>
        </div>
    </div>
