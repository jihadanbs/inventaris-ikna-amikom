    ...
    <div class="container">
        <div class="row pb-3">
            ...
            <div class="col-md-3 fw-bold">
                <form action="/admin/feedback/send" method="post" enctype="multipart/form-data" class="footer">
                    <?= csrf_field(); ?>
                    <div class="mb-4">
                        <label for="nama" class="form-label">Nama<span style="color: red;">*</span></label>
                        <input type="text" class="nama form-control" id="nama" name="nama" placeholder="Masukkan Nama Anda">
                    </div>
                    <div class="mb-4">
                        <label for="email" class="form-label">Email<span style="color: red;">*</span></label>
                        <input type="text" class="email form-control" id="email" name="email" placeholder="Masukkan Email Anda">
                    </div>
                    <div class="mb-4">
                        <label for="no_telepon" class="form-label">Nomor Telepon<span style="color: red;">*</span></label>
                        <input type="text" class="no_telepon form-control" id="no_telepon" name="no_telepon" placeholder="No.Telpon yang bisa dihubungi">
                    </div>
                    <div class="mb-4">
            ...
            <div class="col-md-3">
                ...
                <div class="d-grid gap-2 d-md-flex justify-content-md-end mt-3">
                    <button type="submit" class="btn btn-light" id="alertkontak">Kirim</button>
                </div>
            </div>
            </form>
