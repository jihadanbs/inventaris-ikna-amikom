            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Formulir Penolakan</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Form PenolakanPermohonan Informasi Publik</a></li>
                                <li class="breadcrumb-item active">Formulir Penolakan</li>
                            </ol>
                        </div>
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-10">
                    <div class="card border border-secondary rounded p-4">
                        <div class="card-body">
                            <h2 class="text-center mb-4">Formulir Penolakan Permohonan Informasi Publik</h2>
                            ...
                            <form action="/admin/permohonan/reject/<?= $pemohon->id_pemohon ?>" method="post" enctype="multipart/form-data" id="validationForm" novalidate>
                                <?= csrf_field(); ?>
                                ...
                                <div class="mb-3">
                                    <label for="tanggal_ditolak" class="col-form-label">Tanggal Penolakan :</label>
                                    <input type="date" class="form-control  <?= ($validation->hasError('tanggal_ditolak')) ? 'is-invalid' : ''; ?>" name="tanggal_ditolak" id="tanggal_ditolak" style="background-color: white;"><? old('tanggal_ditolak'); ?></input>

                                    <div class="invalid-feedback">
                                        <?= $validation->getError('tanggal_ditolak'); ?>
                                    </div>
                                </div>

                                <div class="mb-3">
                                    <label for="catatan" class="col-form-label">Catatan Penolakan :</label>
                                    <textarea autofocus class="form-control custom-border <?= ($validation->hasError('catatan')) ? 'is-invalid' : ''; ?>" required name="catatan" placeholder="Masukkan Catatan Penolakan" id="catatan" cols="30" rows="5" style="background-color: white;"><?php echo old('catatan'); ?></textarea>
