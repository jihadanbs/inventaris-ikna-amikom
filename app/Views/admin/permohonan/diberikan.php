            ...
            <div class="row justify-content-center">
                ...
                <div class="col-10">
                    <div class="card border border-secondary rounded p-4">
                        <div class="card-body">
                            <h2 class="text-center mb-4">Formulir Pemberian Permohonan Informasi Publik</h2>
                            ...
                            <form action="/admin/permohonan/berikan/<?= $pemohon->id_pemohon ?>" method="post" enctype="multipart/form-data" id="validationForm" novalidate>
                                <?= csrf_field(); ?>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="col-sm-12">
                                        <input disabled type="text" class="form-control" id="nama_pemohon" style="background-color: #C7C8CC;" name="nama_pemohon" value="<?= old('email', $pemohon->email); ?>">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6 mb-3 separator">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3 separator">
                                        <label for="tanggal_diberikan" class="col-form-label">Tanggal Pemberian :</label>
                                        <input type="date" class="form-control  <?= ($validation->hasError('tanggal_diberikan')) ? 'is-invalid' : ''; ?>" name="tanggal_diberikan" id="tanggal_diproses" style="background-color: white;"><? old('tanggal_diberikan'); ?></input>

                                        <div class="invalid-feedback">
                                            <?= $validation->getError('tanggal_diberikan'); ?>
                                        </div>
                                    </div>

                                    <div class="col-md-6 mb-3">
                                        <label for="file_setuju_1" class="col-form-label">File Yang Akan Diberikan :</label>
                                        <input type="file" class="form-control custom-border" id="file_setuju_1" name="file_setuju_1" style="background-color: white;" <?= (old('file_setuju_1')) ? 'disabled' : 'required'; ?>>
                                        <small class="form-text text-muted">Ukuran File Maksimal 5 MB</small>
                                    </div>

                                </div>

                                <div class="mb-3">
                                    <label for="catatan" class="col-form-label">Catatan Pemberian :</label>
                                    <textarea autofocus class="form-control custom-border <?= ($validation->hasError('catatan')) ? 'is-invalid' : ''; ?>" required name="catatan" placeholder="Masukkan Catatan Pemberian" id="catatan" cols="30" rows="5" style="background-color: white;"><?php echo old('catatan'); ?></textarea>
