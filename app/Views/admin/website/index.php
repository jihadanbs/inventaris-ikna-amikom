            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Data Website Wilayah</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Website Wilayah</a></li>
                                <li class="breadcrumb-item active">Data Website Wilayah</li>
                            </ol>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <table id="example1" class="table table-bordered dt-responsive nowrap w-100">
                                ...
                                <div class="col-md-3 mb-3">
                                    <a href="/admin/website/tambah" class="btn waves-effect waves-light" style="background-color: #28527A; color:white;">
                                ...
                                <tbody>
                                    <?php $i = 1; ?>
                                    <?php foreach ($tb_wilayah as $row) : ?>
                                        <tr>
                                            <td data-field="id_wilayah" style="max-width: 5px" scope="row"><?= $i++; ?></td>
                                            <td data-field="gambar_wilayah">
                                                <img src="<?= base_url($row->gambar_wilayah); ?>" alt="Gambar Wilayah" style="width: 60px; height: 60px;">
                                            </td>
                                            <td data-field="nama_wilayah"><?= $row->nama_wilayah; ?></td>
                                            <td data-field="link_wilayah"><?= $row->link_wilayah; ?></td>
                                            <td style="width: 155px">
                                                <a href="/admin/website/cek_data/<?= $row->id_wilayah ?>" class="btn btn-info btn-sm view"><i class="fa fa-eye"></i> Cek</a>
                                                <button type="button" class="btn btn-danger btn-sm waves-effect waves-light sa-warning" data-id="<?= $row->id_wilayah ?>">
            ...
            $('.sa-warning').click(function(e) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            type: "POST",
                            url: "<?= site_url('/admin/website/delete') ?>", // Ubah sesuai dengan URL
                            data: {
