                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($tb_informasi_publik as $row) : ?>
                                        <tr>
                                            ...
                                            <td data-field="judul"><?= truncateText($row->judul, 30); ?></td>
                                            <td data-field="tanggal_file"><?= $row->tanggal_file; ?></td>
                                            <td style="width: 155px">
                                                <a href="/admin/informasi_publik/cek_data/<?= $row->id_informasi_publik ?>" class="btn btn-info btn-sm view"><i class="fa fa-eye"></i> Cek</a>
                                                <button type="button" class="btn btn-danger btn-sm waves-effect waves-light sa-warning" data-id="<?= $row->id_informasi_publik ?>">
            ...
            $('.sa-warning').click(function(e) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            type: "POST",
                            url: "<?= site_url('/admin/informasi_publik/delete') ?>",
                            data: {
