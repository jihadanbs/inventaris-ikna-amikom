                    ...
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        ...
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Form Pemberian Keberatan Informasi Publik</a></li>
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-10">
                    <div class="card border border-secondary rounded p-4">
                        <div class="card-body">
                            <h2 class="text-center mb-4">Formulir Pemberian Keberatan Informasi Publik</h2>
                            ...
                            <form action="/admin/keberatan/berikan/<?= $keberatan['id_keberatan'] ?>" method="post" enctype="multipart/form-data" id="validationForm" novalidate>
                                <?= csrf_field(); ?>
                                ...
                                <div class="mb-3">
                                    <label for="file_diberikan" class="col-form-label">Upload File Yang Diberikan (Jika Ada) :</label>
                                    <input type="file" accept="application/pdf" class="form-control <?= ($validation->hasError('file_diberikan')) ? 'is-invalid' : ''; ?>" id="file_diberikan" name="file_diberikan" style="background-color: white;" <?= (old('file_diberikan')) ? 'disabled' : 'required'; ?>>
