            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Data Keberatan Informasi Publik</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Standar Layanan</a></li>
                        ...
                        <div class="card-body">
                            <table id="example1" class="table table-bordered dt-responsive nowrap w-100">
                                ...
                                <!-- <div class="col-md-3 mb-3">
                                    <a href="/admin/keberatan/tambah" class="btn waves-effect waves-light" style="background-color: #28527A; color:white;">
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($tb_keberatan as $row) : ?>
                                        <tr>
                                            <td data-field="id_keberatan" style="width: 10px" scope="row"><?= $i++; ?></td>
                                            <td data-field="nama"><?= truncateText($row['nama'], 10); ?></td>
                                            <td data-field="email"><?= $row['email']; ?></td>
                                            <td data-field="ringkasan_kasus"><?= truncateText($row['ringkasan_kasus'], 30); ?></td>
                                            ...
                                            <td style="width: 155px">
                                                <a href="/admin/keberatan/cek_data/<?= $row['id_keberatan'] ?>" class="btn btn-info btn-sm view"><i class="fa fa-eye"></i> Cek</a>
                                                <button type="button" class="btn btn-danger btn-sm waves-effect waves-light sa-warning" data-id="<?= $row['id_keberatan'] ?>">
            ...
            $('.sa-warning').click(function(e) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            type: "POST",
                            url: "<?= site_url('/admin/keberatan/delete') ?>",
                            data: {
