                    ...
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        ...
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Form Pemrosesan Keberatan Informasi Publik</a></li>
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-10">
                    <div class="card border border-secondary rounded p-4">
                        <div class="card-body">
                            <h2 class="text-center mb-4">Formulir Pemrosesan Keberatan Informasi Publik</h2>
                            ...
                            <form action="/admin/keberatan/proses/<?= $keberatan['id_keberatan'] ?>" method="post" enctype="multipart/form-data" id="validationForm" novalidate>
                                <?= csrf_field(); ?>
