...
<div class="main-content">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Data Barang Baru</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="<?= site_url('admin/barang_baru') ?>">Barang IKNA</a></li>
                                <li class="breadcrumb-item active">Data Barang Baru</li>
                            </ol>
                        </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            ?>
                            <table id="tableBarangBekas" class="table table-bordered dt-responsive nowrap w-100">
                                ...
                                <tbody>
                                    <?php $i = 1; ?>
                                    <?php foreach ($barang_bekas as $row) : ?>
                                        <tr>
    ...
    <script>
        $(document).ready(function() {
            ...
            }).buttons().container().appendTo('#tableBarangBekas_wrapper .col-md-6:eq(0)');
        });
    </script>
